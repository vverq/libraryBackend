...
class WebExceptionHandler : IWebExceptionHandler, ProblemHandling {
    ...
    protected fun handleException(ex: AlreadyExistsException, request: NativeWebRequest): ResponseEntity<Problem?>? {
        return create(Status.CONFLICT, "Already Exists", ex.message ?: "", request)
    }
}